...
use Wf\DockerWorkflowBundle\Exception\ArrayExpectedConfigurationException;
...
//        ];
        return [
            ...
            'change int value with null' => [
                ['test' => 1],
                ['test' => null],
                ['test' => null],
            ],
            'change array value with null' => [
                ['test' => ['subvalue' => 1]],
                ['test' => null],
                ['test' => null],
            ],
            'change null value with array' => [
                ['test' => null],
                ['test' => ['subvalue' => 1]],
                ['test' => ['subvalue' => 1]],
            ],
            'change string value with array' => [
                ['test' => 'string'],
                ['test' => ['subtest' => 'array']],
                ['test' => ['subtest' => 'array']],
            ],
